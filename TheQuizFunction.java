            ...
            if (answer == null) {
                ...
                for (Quiz quiz : quizArchive.getQuizzes()) {
                    if (quiz.getCourse().equals(courseTitle))
                        JOptionPane.showMessageDialog(null, (++x) + ". " + quiz.getName(),
                ...
                try {
                    ...
                    boolean imported = PrintInformation.readQuizQuestions(quizArchive, fileAnswer);
                    if (!imported) {
                        JOptionPane.showMessageDialog(null,
                                "A file was created because the path was not found.", "Quiz Portal",
                                JOptionPane.INFORMATION_MESSAGE);
                        creatingAQuiz(quizArchive, courseTitle);
                        PrintInformation.writeQuizQuestions(quizArchive);
                        var allQuizzes = quizArchive.getQuizzes();
                        PrintInformation.writeImportedQuizQuestions(allQuizzes.get(allQuizzes.size() - 1), fileAnswer);
                    } else
                        JOptionPane.showMessageDialog(null,
                    ...
                    JOptionPane.showMessageDialog(null,"Wrong format!", "Quiz Portal",
                            JOptionPane.ERROR_MESSAGE);
                }
                ...
                if (quiz.isTaken()) {
                   ...
                   JOptionPane.showMessageDialog(null, allQuizzes, "Quiz Portal",
                    ...
                    for (int j = 0; j < quiz.getStudentAnswers().size(); j++) {
                        ...
                        JOptionPane.showMessageDialog(null, studentAnswers, "Quiz Portal",
                                JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, questionsCorrect + score + timestamp,
                            "Quiz Portal", JOptionPane.INFORMATION_MESSAGE);
                }
